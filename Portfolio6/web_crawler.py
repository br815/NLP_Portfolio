...
def important_terms(input_filename):
    ...
    # tokens_list = [tok.lower() for tok in word_tokenize(raw_text) if tok.isalpha() and tok not in stopwords.words('english')]
    # ^ This code isn't removing stopwords for some reason.
...
def knowledge_base(term, input_filename):
    ...
    # my very first thought, as I roused from my dreams, was to implement the knowledge base
    # using list comprehension in the function and 2 nested for-loops in main().
